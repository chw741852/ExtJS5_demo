...
<div id="absolute-details">
    ...
    <p><a href="http://docs.sencha.com/extjs/5.0.0/#!/api/Ext.layout.container.Absolute" target="_blank">API Reference</a></p>
</div>
<div id="accordion-details">
    ...
    <p><a href="http://docs.sencha.com/extjs/5.0.0/#!/api/Ext.layout.container.Accordion" target="_blank">API Reference</a></p>
</div>
<div id="anchor-details">
    ...
    <p><a href="http://docs.sencha.com/extjs/5.0.0/#!/api/Ext.layout.container.Anchor" target="_blank">API Reference</a></p>
</div>
<div id="border-details">
    ...
    <p><a href="http://docs.sencha.com/extjs/5.0.0/#!/api/Ext.layout.container.Border" target="_blank">API Reference</a></p>
</div>
<div id="card-tabs-details">
    ...
    <p><a href="http://docs.sencha.com/extjs/5.0.0/#!/api/Ext.layout.container.Card" target="_blank">Card layout API Reference</a></p>
    <p><a href="http://docs.sencha.com/extjs/5.0.0/#!/api/Ext.tab.Panel" target="_blank">TabPanel API Reference</a></p>
</div>
<div id="card-wizard-details">
    ...
    <p><a href="http://docs.sencha.com/extjs/5.0.0/#!/api/Ext.layout.container.Card" target="_blank">API Reference</a></p>
</div>
<div id="column-details">
    ...
    <p><a href="http://docs.sencha.com/extjs/5.0.0/#!/api/Ext.layout.container.Column" target="_blank">API Reference</a></p>
</div>
<div id="fit-details">
    ...
    <p><a href="http://docs.sencha.com/extjs/5.0.0/#!/api/Ext.layout.container.Fit" target="_blank">API Reference</a></p>
</div>
<div id="table-details">
    ...
    <p><a href="http://docs.sencha.com/extjs/5.0.0/#!/api/Ext.layout.container.Table" target="_blank">API Reference</a></p>
</div>
...
<div id="vbox-details">
    ...
    <p><a href="http://docs.sencha.com/extjs/5.0.0/#!/api/Ext.layout.container.VBox" target="_blank">API Reference</a></p>
</div>
...
<div id="hbox-details">
    ...
    <p><a href="http://docs.sencha.com/extjs/5.0.0/#!/api/Ext.layout.container.HBox" target="_blank">API Reference</a></p>
</div>
...
<!-- Form layouts -->
<div id="mixed-form-details">
    <h2>Mixed Layout Form</h2>
    <p>Forms can use any different layout for flexible control over
        positioning of fields and labels in containers.  In this example, a mixture of box, docking and anchor layout are used
        and  to position fields. The field widths are anchored to the right and/or bottom of the container.</p>
</div>
</div>
</body>
</html>
